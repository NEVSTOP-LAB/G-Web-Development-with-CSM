(function () {
    ...
    const openNewWindowLocation = function(url) {
		window.open(url);
    }    
    ...
    const SetWindowTitle = function(String){
		document.title = String;
    }
    
    const GetWindowTitle = function(){
		return document.title
	}

    window.WebVIURL = {parseURL, parseURLSearchParams, getWindowLocation, setWindowLocation, replaceWindowLocation, openNewWindowLocation, CloseWindow, SetWindowTitle, GetWindowTitle};
}());
